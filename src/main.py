...
def show_info():
    showInfo(
        'The configuration via config.json is phased out since Straight Reward v0.4.\n'
        'To configure the functionality of this add-on, go to the Deck Overview, '
        'choose a Deck, click the wheel to its right, select "Options", and in resulting window '
